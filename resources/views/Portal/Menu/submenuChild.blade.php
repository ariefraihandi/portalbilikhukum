    ...
    <div class="row g-4">
      ...
      <div class="col-xl-12 col-lg-12 col-md-12 order-0 order-md-1">
        <ul class="nav nav-pills flex-column flex-md-row mb-3">
          ...
          <li class="nav-item col-4">
              <a class="nav-link" href="/menu/submenu"><i class="bx bx-menu me-1"></i>Submenu</a>
          </li>
          <li class="nav-item col-4">
              <a class="nav-link active" href="/menu/childmenu"><i class="bx bx-menu-alt-right me-1"></i>Child Menu</a>
          </li>
        </ul>
        <!-- Role Table -->
        <div class="card">
