                        ...
                        <div class="d-flex flex-wrap flex-lg-nowrap gap-3 align-items-end">
                            <div class="w-75">
                                ...
                                <input
                                    ...
                                    name="referralLink"
                                    class="form-control w-100"
                                    value="portal.bilikhukum.com/join?token={{$hasReferralCode->code}}"
                                    readonly
                                />
                            </div>
                            <div class="d-flex">
                                ...
                                <button type="button" class="btn btn-success btn-icon" onclick="shareToWhatsApp('portal.bilikhukum.com/join?token={{$hasReferralCode->code}}')">
