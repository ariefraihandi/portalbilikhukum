        ...
        <div class="col-12">
          <div class="property-slider-wrap">
            <div class="property-slider">
              ...
              <div class="property-item">
                <a href="property-single.html" class="img">
                  <img src="{{ asset('assets/index/assets') }}/images/img_2.jpg" alt="Image" class="img-fluid" />
                </a>
              ...
              <div class="property-item">
                <a href="property-single.html" class="img">
                  <img src="{{ asset('assets/index/assets') }}/images/img_3.jpg" alt="Image" class="img-fluid" />
                </a>
              ...
              <div class="property-item">
                <a href="property-single.html" class="img">
                  <img src="{{ asset('assets/index/assets') }}/images/img_4.jpg" alt="Image" class="img-fluid" />
                </a>
              ...
              <div class="property-item">
                <a href="property-single.html" class="img">
                  <img src="{{ asset('assets/index/assets') }}/images/img_5.jpg" alt="Image" class="img-fluid" />
                </a>
              ...
              <div class="property-item">
                <a href="property-single.html" class="img">
                  <img src="{{ asset('assets/index/assets') }}/images/img_6.jpg" alt="Image" class="img-fluid" />
                </a>
              ...
              <div class="property-item">
                <a href="property-single.html" class="img">
                  <img src="{{ asset('assets/index/assets') }}/images/img_7.jpg" alt="Image" class="img-fluid" />
                </a>
              ...
              <div class="property-item">
                <a href="property-single.html" class="img">
                  <img src="{{ asset('assets/index/assets') }}/images/img_8.jpg" alt="Image" class="img-fluid" />
                </a>
