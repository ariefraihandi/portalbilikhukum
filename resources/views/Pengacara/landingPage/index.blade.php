...
<head>
    ...
    <!-- Favicon Icon -->
    <link rel="shortcut icon" href="{{ asset('assets/index/landingPage') }}/images/favicon.png" type="image/x-icon">
                ...
                <div class="container container-1620 clearfix">
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="index.html"><img src="{{ asset('assets/index/landingPage') }}/images/logos/logo_home_20.png" alt="Logo" title="Logo"></a></div>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                <div class="navbar-header">
                                   <div class="mobile-logo my-15">
                                       <a href="index.html">
                                            <img src="{{ asset('assets/index/landingPage') }}/images/logos/logo.png" alt="Logo" title="Logo">
                                       </a>
                                   </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-sm-7">
                        <div class="hero-content rmb-55 wow fadeInUp delay-0-2s">
                            <span class="h2">Kantor Pengacara</span>
                            <h1><b>Arief Raihandi Azka, S.H., M.H</b> web designer</h1>
                    ...
                    <div class="col-lg-5">
                        <div class="author-image-part wow fadeIn delay-0-3s">
                            ...
                            <img src="{{ asset('assets/img/office/site/') }}/default-image.webp" alt="Author">
                    ...
                    <div class="row gap-100 align-items-center">
                        ...
                        <div class="col-lg-5">
                            <div class="about-image-part wow fadeInUp delay-0-3s">
                                <img src="{{ asset('assets/index/landingPage') }}/images/about/about.jpg" alt="About Me">
                                ...
                                <div class="about-btn btn-two wow fadeInRight delay-0-5s">
                                    <img src="{{ asset('assets/index/landingPage') }}/images/about/btn-image2.png" alt="Image">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                        <div class="skill-item wow fadeInUp delay-0-2s">
                                            <img src="{{ asset('assets/index/landingPage') }}/images/skills/skill1.png" alt="Skill">
                                            <h5>Figma</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                        <div class="skill-item wow fadeInUp delay-0-3s">
                                            <img src="{{ asset('assets/index/landingPage') }}/images/skills/skill2.png" alt="Skill">
                                            <h5>Figma</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                        <div class="skill-item wow fadeInUp delay-0-4s">
                                            <img src="{{ asset('assets/index/landingPage') }}/images/skills/skill3.png" alt="Skill">
                                            <h5>Figma</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                        <div class="skill-item wow fadeInUp delay-0-5s">
                                            <img src="{{ asset('assets/index/landingPage') }}/images/skills/skill4.png" alt="Skill">
                                            <h5>Figma</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                        <div class="skill-item wow fadeInUp delay-0-2s">
                                            <img src="{{ asset('assets/index/landingPage') }}/images/skills/skill5.png" alt="Skill">
                                            <h5>Figma</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                        <div class="skill-item wow fadeInUp delay-0-3s">
                                            <img src="{{ asset('assets/index/landingPage') }}/images/skills/skill6.png" alt="Skill">
                                            <h5>Figma</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                        <div class="skill-item wow fadeInUp delay-0-4s">
                                            <img src="{{ asset('assets/index/landingPage') }}/images/skills/skill7.png" alt="Skill">
                                            <h5>Figma</h5>
                                    ...
                                    <div class="col-xl-3 col-lg-4 col-md-3 col-sm-4 col-6">
                                        <div class="skill-item wow fadeInUp delay-0-5s">
                                            <img src="{{ asset('assets/index/landingPage') }}/images/skills/skill8.png" alt="Skill">
                                            <h5>Figma</h5>
            ...
            <div class="container">
                ...
                <div class="row align-items-center pb-25">
                    <div class="col-lg-6">
                        <div class="project-image wow fadeInLeft delay-0-2s">
                            <img src="{{ asset('assets/index/landingPage') }}/images/projects/project1.jpg" alt="Project">
                        </div>
                    </div>
                ...
                <div class="row align-items-center pb-25">
                    <div class="col-lg-6 order-lg-2">
                        <div class="project-image wow fadeInLeft delay-0-2s">
                            <img src="{{ asset('assets/index/landingPage') }}/images/projects/project2.jpg" alt="Project">
                        </div>
                    </div>
                ...
                <div class="row align-items-center pb-25">
                    <div class="col-lg-6">
                        <div class="project-image wow fadeInLeft delay-0-2s">
                            <img src="{{ asset('assets/index/landingPage') }}/images/projects/project3.jpg" alt="Project">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6">
                        <div class="project-content wow fadeInRight delay-0-2s">
                ...
                <div class="row align-items-center pb-25">
                    <div class="col-lg-6 order-lg-2">
                        <div class="project-image wow fadeInLeft delay-0-2s">
                            <img src="{{ asset('assets/index/landingPage') }}/images/projects/project4.jpg" alt="Project">
                        </div>
                    </div>
                    <div class="col-xl-5 col-lg-6 ms-auto">
                        <div class="project-content wow fadeInRight delay-0-2s">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        <div class="contact-form contact-form-wrap form-style-one wow fadeInUp delay-0-4s">
                            <form id="contactForm" class="contactForm" name="contactForm" action="{{ asset('assets/index/landingPage') }}/php/form-process.php" method="post">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
            ...
            <div class="container">
                ...
                <div class="client-logo-wrap">
                    <a class="client-logo-item wow fadeInUp delay-0-2s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo1.png" alt="Client Logo">
                    </a>
                    <a class="client-logo-item wow fadeInUp delay-0-3s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo2.png" alt="Client Logo">
                    </a>
                    <a class="client-logo-item wow fadeInUp delay-0-4s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo3.png" alt="Client Logo">
                    </a>
                    <a class="client-logo-item wow fadeInUp delay-0-5s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo4.png" alt="Client Logo">
                    </a>
                    <a class="client-logo-item wow fadeInUp delay-0-6s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo5.png" alt="Client Logo">
                    </a>
                    <a class="client-logo-item wow fadeInUp delay-0-2s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo6.png" alt="Client Logo">
                    </a>
                    <a class="client-logo-item wow fadeInUp delay-0-3s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo7.png" alt="Client Logo">
                    </a>
                    <a class="client-logo-item wow fadeInUp delay-0-4s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo8.png" alt="Client Logo">
                    </a>
                    <a class="client-logo-item wow fadeInUp delay-0-5s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo9.png" alt="Client Logo">
                    </a>
                    <a class="client-logo-item wow fadeInUp delay-0-6s" href="contact.html">
                        <img src="{{ asset('assets/index/landingPage') }}/images/client-logos/client-logo10.png" alt="Client Logo">
                    </a>
                </div>
            </div>
            <div class="bg-lines">
                        ...
                        <div class="col-lg-2 col-md-12">
                            <div class="footer-widget widget_logo wow fadeInUp delay-0-2s">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{ asset('assets/index/landingPage') }}/images/logos/logo.png" alt="Logo"></a>
                                </div>
                            </div>
                        </div>
